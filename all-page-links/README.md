# All Page Links ( Bookmarklet ) v0.9.8 от 05.08.2017
...
* Если в списке присутствует ссылка на текущую страницу сайта, она подсвечивается тёмно-красным цветом.
* Ссылки на главную и текущую страницы сайта добавляются в список даже если их нет на странице.
