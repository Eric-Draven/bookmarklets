...
* Букмарклет также умеет:
  * декодировать кириллические домены: **xn--80aswg.xn--p1ai** >>> **сайт.рф**
  * декодировать **UTF-8** символы в URL: **%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80** >>> **пример**
  * декодировать **CP-1251** символы в URL: **%EF%F0%E8%EC%E5%F0** >>> **пример**
